...
export default function TodoTwo() {
    ...
    const handleForm = (e) => {
        e.preventDefault()
        const newTodo = { title, description, deadline }
                                    ...
                                    <div className="card-body">
                                        {editId !== todo._id ? (
                                            <>
                                                ...
                                                {/* <small className="text-muted">createdAt: {new Date(todo.createdAt).toISOString().split('T')[0]}</small> */}
                                                {/* <small className="text-muted">Deadline: {todo.deadline ? new Date(todo.deadline).toISOString().split('T')[0] : 'not mentioned'}</small> */}
